...
function main {
    ...
    UNTIL periapsis > lowSfOb{//71000
        ...
        if apoapsis < (lowestSafeOrbit-1000) and mode < 1{//70000
            //Steering control
        ...
        if apoapsis > (lowSfOb-1000) and apoapsis < (lowSfOb*1.126) and mode <= 1{//80000{
            //Steering control
        ...
        if apoapsis > (lowSfOb*1.126) and (mode = 1 or mode = 2){ //and altitude < (lowSfOb-1000) and mode = 1{
            //rcs on.
            //Steering control
        ...
        if altitude > (lowSfOb-1000) and mode = 2{
            rcs off.
            ...
            run execute_node.
            wait 1.
            if periapsis < (lowSfOb-1000){lock steering to prograde. lock throttle to .1.}
